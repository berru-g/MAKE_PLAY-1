...
const int buttonPin[NButtons] = {2, 3, 7, 11, 13}; //* pinos de cada botão conectado diretamente ao Arduino
...
/////////////////////////////////////////////
// POTENCIOMETROS
const int N_POTS = 10; //* número total de pots (slide e rotativo)
const int POT_ARDUINO_PIN[N_POTS] = {A0, A1, A2, A3, A4, A5, A6, A7, A10, A11}; //* pinos de cada pot conectado diretamente ao Arduino
